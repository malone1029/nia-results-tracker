...
const variants = {
  primary: 'bg-nia-dark-solid text-white hover:bg-nia-grey-blue focus-ring',
  secondary:
    'bg-card text-foreground border border-border hover:bg-surface-hover hover:border-border focus-ring',
  ghost: 'bg-transparent text-foreground hover:bg-surface-subtle focus-ring',
  danger: 'bg-nia-red text-white hover:opacity-80 focus-ring',
  success: 'bg-nia-green text-white hover:opacity-90 focus-ring',
  accent: 'bg-nia-orange text-white hover:bg-nia-orange-dark focus-ring',
} as const;
