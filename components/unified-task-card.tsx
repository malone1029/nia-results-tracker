      ...
      <div className="flex items-start gap-2">
        ...
        {showCheckbox && (
          <button
            ...
            } ${isAnySelected ? 'opacity-100' : 'opacity-0 group-hover/task:opacity-100'}`}
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-1 flex-wrap">
            {/* Assignee */}
            <span
              className={`text-[10px] ${task.assignee_name ? 'text-text-secondary' : 'text-text-muted'}`}
            >
            ...
            {(attachmentCount || 0) > 0 && (
              <span
                className="text-text-muted flex items-center gap-0.5 text-[10px]"
