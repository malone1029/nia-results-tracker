...
export async function GET() {
  ...
  try {
    ...
    let nextPage: string | null =
      `/projects?workspace=${tokenRow.workspace_id}&opt_fields=name,notes,modified_at,team.name,archived&limit=100`;
    ...
    allProjects.sort((a, b) => (b.modified_at || '').localeCompare(a.modified_at || ''));
