...
function TemplatePicker({
  ...
  const grouped = templates.reduce<Record<string, SurveyTemplate[]>>(
    (acc, t) => {
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="bg-card rounded-xl border border-border shadow-sm p-6 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-semibold text-nia-dark">
              Generate with AI
            </h2>
          </div>
          <p className="text-sm text-text-secondary">
            Describe what you want to measure and AI will create a complete
            survey with mixed question types.
          </p>
          <Textarea
            value={aiPrompt}
              ...
              <div key={category} className="space-y-2">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {tmpls.map((t) => (
                    ...
                    >
                      <div className="font-medium text-sm text-nia-dark">
                        {t.name}
                      </div>
                      {t.description && (
