...
export default function NewProcessPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-nia-dark">Create New Process</h1>
        <p className="text-text-tertiary mt-1">
          Start with the basics, then use the edit page or AI to build out Charter and ADLI
          sections.
        </p>
      </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-text-tertiary">
              Answer a few questions and AI builds a complete process with Charter and ADLI
              sections.
            </p>
          </div>
          <svg
            className="w-5 h-5 text-text-muted ml-auto flex-shrink-0"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
            viewBox="0 0 24 24"
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <p className="mt-1.5 text-xs text-text-muted">
            Key processes directly create value. Support processes enable key processes.
          </p>
        </div>

        <Textarea
          label="What is this process?"
          value={description}
