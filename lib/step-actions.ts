...
export const STEPS: StepDef[] = [
  {
    ...
    shortLabel: 'Start',
    welcome:
      "Let's get started! I'll help you understand where this process stands and what to focus on first.",
    prominence: 'muted',
    actions: [
      {
        key: 'start',
        ...
        prompt:
          'Welcome me to this process and give me an overview of where things stand. What should I focus on first?',
      ...
      },
      {
        ...
        prompt:
          'Analyze this process using the ADLI framework. Score each dimension, identify the biggest gaps, and suggest the 2-3 most impactful improvements with effort estimates.',
    ...
    actions: [
      {
        ...
        prompt:
          "Review this charter briefly. List what content types are mixed in (e.g., ADLI assessments, PDSA cycles, Baldrige links, task lists). For each, say which field it should move to. Keep your response short — just the analysis, no rewritten content yet. I'll ask you to generate the cleanup if I want to proceed.",
      ...
      },
      {
        ...
        prompt:
          'Coach me on this process. What are the 2-3 quickest wins I could tackle right now to improve maturity?',
        scrollTarget: 'section-charter',
        color: 'nia-green',
      ...
      },
      {
        ...
        prompt:
          "Help me strengthen this process by asking me targeted questions about what's missing or underdeveloped. Start with the weakest area. Ask 2-3 questions at a time.",
        scrollTarget: 'section-charter',
        color: 'nia-grey-blue',
        borderClass: 'border-nia-grey-blue/30',
        bgClass: 'bg-nia-grey-blue/5 hover:bg-nia-grey-blue/10',
  ...
  },
  {
    ...
    shortLabel: 'Assess',
    welcome:
      "Time to score your ADLI maturity. I'll assess each dimension and find your biggest gaps.",
    prominence: 'normal',
    actions: [
      {
        key: 'assessment',
      ...
      },
      {
        ...
        prompt:
          "Review the metrics linked to this process. Are there gaps in what I'm measuring? Are there existing metrics in the system I should link? Flag any overdue or off-target metrics. Recommend specific metrics to link or create.",
      ...
      },
      {
        ...
        prompt:
          'Review this charter briefly. List what content types are mixed in (e.g., ADLI assessments, PDSA cycles, Baldrige links). For each, say which field it should move to. Keep your response short — just the analysis.',
        scrollTarget: 'section-charter',
        color: 'nia-grey-blue',
        borderClass: 'border-nia-grey-blue/30',
        bgClass: 'bg-nia-grey-blue/5 hover:bg-nia-grey-blue/10',
    ...
    actions: [
      {
        ...
        prompt:
          'Focus on the weakest ADLI dimension for this process. Give me specific, actionable improvements with content I can apply. Include effort estimates and tasks.',
        scrollTarget: 'section-adli',
        color: 'nia-orange',
        borderClass: 'border-nia-orange/30',
        bgClass: 'bg-nia-orange/5 hover:bg-nia-orange/10',
  ...
  },
  {
    ...
    shortLabel: 'Tasks',
    welcome:
      "Ready to build your task list! I'll interview you about what needs to happen and generate PDCA tasks.",
    prominence: 'normal',
    actions: [
      {
        key: 'tasks',
      ...
      },
      {
        ...
        description: 'quick wins',
        prompt:
          'Coach me on this process. What are the 2-3 quickest wins I could tackle right now?',
        scrollTarget: 'section-adli',
        color: 'nia-green',
        borderClass: 'border-nia-green/30',
        bgClass: 'bg-nia-green/5 hover:bg-nia-green/10',
    ...
    actions: [
      {
        ...
        prompt:
          "Review this process before I export to Asana. Summarize what's strong, what's still weak, and whether the charter and ADLI sections are ready. Flag anything I should fix first.",
        scrollTarget: 'section-top',
        color: 'nia-green',
        borderClass: 'border-nia-green/30',
        bgClass: 'bg-nia-green/5 hover:bg-nia-green/10',
      ...
      },
      {
        ...
        prompt:
          "Help me build more tasks for this process before I export. What's missing from the task list?",
        scrollTarget: 'section-tasks',
        switchTab: 'tasks',
        color: 'nia-dark',
        borderClass: 'border-nia-dark/20',
...
export const DEFAULT_ACTIONS: StepActionDef[] = [
  {
    ...
    prompt:
      'Analyze this process using the ADLI framework. Score each dimension (Approach, Deployment, Learning, Integration), identify the biggest gaps, and suggest the 2-3 most impactful improvements with effort estimates.',
    scrollTarget: 'section-adli',
    color: 'nia-orange',
    borderClass: 'border-nia-orange/30',
    bgClass: 'bg-nia-orange/5 hover:bg-nia-orange/10',
  ...
  },
  {
    ...
    prompt:
      'Coach me on this process. What are the 2-3 quickest wins I could tackle right now to improve maturity? Focus on what will make the biggest difference with the least effort.',
    scrollTarget: 'section-charter',
    color: 'nia-green',
    borderClass: 'border-nia-green/30',
    bgClass: 'bg-nia-green/5 hover:bg-nia-green/10',
